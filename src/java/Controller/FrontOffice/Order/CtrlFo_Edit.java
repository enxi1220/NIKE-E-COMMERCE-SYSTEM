 ...
 * @author Lim En Xi
 */
@WebServlet(name = "FoEditOrder", urlPatterns = {"/FoEditOrder"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Order order = new Order().setOrderId(orId)
                    .setStatus(Helper.Constant.getStatus(Constant.StatusEnum.Completed))
            ...
            out.print("Your order has been completed. Thank you for your support.");
        } catch (Exception e) {
