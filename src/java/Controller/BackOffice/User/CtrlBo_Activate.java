 ...
 * @author Linyi
 */
@WebServlet(name = "BoUserActivate", urlPatterns = {"/BoUserActivate"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
         HttpSession session = request.getSession();
            ...
            new BusinessLogic.BackOffice.User.BllBo_Activate().businessLogic(user);
            out.print("Account " + username + " Activated.");
