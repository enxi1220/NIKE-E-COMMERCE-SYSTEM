 ...
 */
@WebServlet(name = "BoCourierDeactivate", urlPatterns = {"/BoCourierDeactivate"})
public class CtrlBo_Deactivate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            new BusinessLogic.BackOffice.Courier.BllBo_Deactivate().businessLogic(courier);
            out.print("This Courier has been Deactivated.");
