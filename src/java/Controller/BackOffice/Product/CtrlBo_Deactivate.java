 ...
 * @author User
 */
@WebServlet(name = "ProductDeactivate", urlPatterns = {"/ProductDeactivate"})
public class CtrlBo_Deactivate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            new BusinessLogic.BackOffice.Product.BllBo_Deactivate().businessLogic(new Product().setProductId(productId));
           
            out.print("Product has been Deactivated.");
