 ...
 * @author vinnie chin
 */
public class BllFo_GetLatest extends Bll_Super<Product>{
   @Override
    ...
    protected ArrayList<Product> execute(Connection conn, Product domain) throws SQLException{
        ...
        ArrayList<Product> lastestProducts = new DataAccess.FrontOffice.Product.DalFo_GetLatest(conn).run(domain);
